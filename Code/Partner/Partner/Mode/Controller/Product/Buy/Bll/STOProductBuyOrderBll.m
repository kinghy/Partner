...
//            @strongify(self);
//            self.mySection.minMoneyLabel.text = [NSString stringWithFormat:@"%d万",value.integerValue/10000];
//            self.mySection.slider.minimumValue = value.integerValue/10000;
//        }];
//        //绑定最大值
//        [RACObserve(model, maxMoney) subscribeNext:^(NSNumber* value) {
//            @strongify(self);
//            self.mySection.maxMoneyLabel.text = [NSString stringWithFormat:@"%d万",value.integerValue/10000];
...
//            num = num *100;
//            self.mySection.amountLabel.text = [NSString stringWithFormat:@"%ld股（资金利用率%.2f%%）",(long)num,(num*lastestPrice.floatValue/currentValue.floatValue)*100];
//        }];
...
//                self.mySection.rateLabel.text =[NSString stringWithFormat:@"%d%%",[entity.securityDeposit integerValue]*10];
